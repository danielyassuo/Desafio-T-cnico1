...
public class JwtUtil {
    ...
    public String generateToken(String username) {
        return Jwts.builder()
                .setSubject(username) // Define o email de usuário como o assunto do token
    ...
    public Claims extractClaims(String token) {
        return Jwts.parser()
                ...
                .getPayload(); //obtem o payload do corpo do token, que cojntém as claims
    }

    // Extrai o nome de usuário do token JWT
    public String extraitEmailToken(String token) {
    ...
    public boolean validateToken(String token, String username) {
        ...
        final String extractedUsername = extraitEmailToken(token);
